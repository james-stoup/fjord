...
class Fjord(npyscreen.NPSAppManaged):
    ...
    def onStart(self):
        ...
        self.con_form = self.addForm(
            "CONNECTION_FORM", ConnectionForm, name="Connect/Disconnect"
        )
...
class MainForm(npyscreen.ActionForm):
    def create(self):
        self.MyTitle = self.add(
            npyscreen.TitleText, name="Welcome to Fjord", editable=False
        )
        self.ConnectionStatus = self.add(
            npyscreen.TitleText,
            name="Status:",
            value="Disconnected",
            editable=False,
        ...
        self.nextrely += 1
        self.RealLoc = self.add(
            npyscreen.TitleText, name="Real Loc:", value="Home", editable=False
        )
        self.ProjLoc = self.add(
            npyscreen.TitleText, name="Proj Loc:", value="Home", editable=False
        )
        ...
        self.Obfuscate = self.add(
            npyscreen.TitleText, name="Obfuscate", value="disabled"
        )
        self.AutoConnect = self.add(
            npyscreen.TitleText, name="Auto Connect", value="disabled"
        )
        self.DNS = self.add(npyscreen.TitleText, name="DNS", value="disabled")

        self.KillSwitch = self.add(
        ...
        self.nextrely += 1
        self.connectButton = self.add(
            npyscreen.Button,
            name="Connect",
            value_changed_callback=self.connectButtonPress,
        )
